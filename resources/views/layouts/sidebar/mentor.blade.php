        ...
        <ul class="p-4 space-y-2 text-sm">
            ...
            <li>
                <a href="{{ route('mentor.dashboard') }}"
                    ...
                    {{ request()->routeIs('mentor.dashboard') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
            ...
            <li>
                <a href="{{ route('mentor.kegiatan.index') }}"
                    class="flex items-center gap-2 p-2 rounded transition
                    {{ request()->routeIs('mentor.kegiatan.*') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
            ...
            <li>
                <a href="{{ route('mentor.laporan.index') }}"
                    class="flex items-center gap-2 p-2 rounded transition
                    {{ request()->routeIs('mentor.laporan.*') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
            ...
            <li>
                <a href="{{ route('mentor.evaluasi.index') }}"
                    class="flex items-center gap-2 p-2 rounded transition
                    {{ request()->routeIs('mentor.evaluasi.*') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
